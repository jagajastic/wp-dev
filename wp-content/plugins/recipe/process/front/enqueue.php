...
function r_enqueue_scripts()
{
    ...
    wp_register_script('r_rateit', plugins_url('assets/rateit/jquery.rateit.js', RECIPE_PLUGIN_URL), ['jquery'], '1.0.0', true);
    wp_register_script('r_main', plugins_url('assets/js/main.js', RECIPE_PLUGIN_URL), ['jquery'], '1.0.0', true);
